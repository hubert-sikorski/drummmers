...
class Track extends React.Component {
    renderAction = () => {
        if (this.props.isRemoval) {
            return (
                <i
                    className="Track-action fa fa-minus"
            ...
            return (
                <i
                    className="Track-action fa fa-plus"
    ...
    renderPreview = () => {
        if (this.props.track.preview) {
            if (this.props.trackIsPlaying === false) {
                ...
                this.props.trackIsPlaying === true &&
                this.props.track.id !== this.props.trackPlaying
            ) {
                return (
                    <i
                        className="fa fa-play Track-preview-icon"
